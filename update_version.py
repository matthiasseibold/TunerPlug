...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright MatthiasSeibold, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/TunerPlug-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TunerPlug-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TunerPlug-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TunerPlug-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TunerPlug-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TunerPlug-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/TunerPlug-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/TunerPlug.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/TunerPlug.iss",inplace=1):
